    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <h1 className="App-title">Welcome to version {this.props.version} of my Interactive Resume</h1>    
          <p className="App-intro">
          This web app is a live version of my resume, highlighting my skills and hobbies. If you prefer the pdf version, it can be found here.
        </p>
        </header>
        <div class="container">
